                        ...
                        <div class='row g-0'>
                            ...
                            <div class='col-md-5 p-4'>
                                ...
                                <div class='mt-3'>
                                    ...
                                    <p class='text-muted'>Precio por día: " . number_format($coche['precio'], 2) . "€</p>
                                </div>
                            </div>
                            ...
                            <div class='col-md-3 d-flex flex-column justify-content-center align-items-center bg-light border-start'>
                                ...
                                <a href='procesarRenting.php?marca={$coche['marca']}&modelo={$coche['modelo']}&dias={$totalDias}' class='btn btn-primary btn-lg'>Reservar ahora</a>
                            </div>
                        </div>
                    </div>";
                }
